...
define config.name = _("Приключения абитуриента")
...
define gui.about = _p("""
Спасибо что проходите нашу игру \n
Автор: Бездельники \n
Разраб: Костолап 
""")
...
define build.name = "Studentadventure"
...
define config.save_directory = "Studentadventure-1743962594"
...
define config.window_icon = "gui/bg icon.png"
